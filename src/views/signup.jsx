        ...
        <div className={signup.signupBox}>
          ...
          <form className={signup.signupForm}>
            <div className={signup.signupInput}>
              <input className={signup.signup__input} type="signup.text" name="name" onChange={onInputChange} defaultValue={input.name} placeholder="Name or nickname" required/>
            </div>
            <div className={signup.signupInput}>
          ...
          <div className={signup.signupLogin}>
            Already have an account? <Link className={signup.login__link} to="/login">Log in</Link>
          </div>
        </div>
      </div>
    </main>
